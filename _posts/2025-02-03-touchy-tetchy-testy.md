...
It turns out touchy, tetchy, and testy not only sound alike and look alike, but they also mean roughly the same thing.
...
Apparently these are what linguists call [paronyms](https://en.wikipedia.org/wiki/Paronym). In this case the words are near-homophones ("soundalike"), near-homographs ("lookalike"), and also near-cognates ("meanalike"). A linguistic hat trick!
