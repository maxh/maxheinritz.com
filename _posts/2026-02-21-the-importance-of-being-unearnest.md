...
How best to proceed then? I've come around to something like this: find a secret if you can, and start there. But don't expect any of that initial moral clarity to survive contact with the market. So be slow to judge the people playing this game whose behavior you find distasteful, because this appears to be the cost of innovation: the system that produces these people is the same as the one that produced the unprecedented material abundance we all enjoy.
