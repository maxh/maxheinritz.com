...
The personal ledger sheet has created this sort of feedback loop for my financial health. It's gratifying to see the connection between my day-to-day activity and my savings rate. It's useful to compare my expense category breakdown to my values, and see whether I'm spending on the things that actually bring me joy.
